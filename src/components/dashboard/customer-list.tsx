  ...
  return (
    <Card className="py-0 gap-0">
      <CardContent className="p-0">
        ...
        <div className="hidden md:grid md:grid-cols-[1fr_1fr_1fr_auto] px-5 py-3 text-[11px] font-bold uppercase tracking-widest bg-sidebar text-stone-100">
          <span>Name</span>
          <span>Email</span>
          <span>Phone</span>
        ...
        <div className="md:hidden px-5 py-2.5 text-[11px] font-bold uppercase tracking-widest bg-sidebar text-stone-100">
