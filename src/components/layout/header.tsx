...
export function Header({ user }: { user: User | null }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-stone-300 dark:border-stone-800 bg-white/80 dark:bg-stone-900/80 backdrop-blur-xl pt-[env(safe-area-inset-top)]">
